 ...
 * Compiled on:  11/13/2012 8:07:43 PM
 * Compiled by: vestben-PC\vestben
 * Source: C:\Users\vestben\Documents\GitHub\cats-vs-codez\game\Game.coffee      
 * -------------------------------------------------------------------------*/


var activeWave, addGameView, addTitleView, blueButton, branchs, buttonArray, canvas, checkSquare, clearScreen, drawBranch, drawButtons, drawGrid, drawNextBranch, drawSquares, enemyOcupation, fillGrid, g, greenButton, gridsize, handleClickity, handleFileLoad, handleLoadComplete, init, makeButtons, manifest, movingCube, notLegalToDraw, orangeButton, redButton, resetGame, stage, startGame, theColor, tick, totalLoaded, towerGrid, uiCanvas, uiG, uiStage;
...
enemyOcupation = function() {
  movingCube.x += 0.1;
  if (movingCube.x > 17) return movingCube.x = 0.0;
};
